...
const tall = express.Router();
const conexion = require('../../../config/conexion');

//obtiene todos los  talleres
tall.get('/mostrar-taller', (req, res) => { 
conexion.query("call MOSTRAR_TALLER", (err, result) => {
        if (err) {
   ...
   tall.get('/muestre-taller/:id',(req,res)=> {  
...
tall.delete('/eliminar-taller/:id',(req,res)=>{ 
    var cod_taller = req.params.id; 
...
tall.post('/insertar-taller', (req, res) => {
